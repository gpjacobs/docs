...
This guide will show you how to implement the user authentication in an iOS application. For this tutorial, we will use the iOS demo from GitHub and show you step by step how to run it.
...
You need to pass the SOTT value at the time of registration and you can generate this from the [dashboard](https://dashboard.loginradius.com/dashboard). 

Open the dashboard, click on "Configure Your Application" and open **Mobile SOTT** . Now set the time according to the requirement and generate the SOTT.
...
```
5. In Xcode, right-click on your project's .plist file and select Open As -> Source Code. **The default plist is usually your Info.plist file**
